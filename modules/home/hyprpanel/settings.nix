{
  ...
  "wallpaper.image" = "/home/mitra/Pictures/Wallpapers/pexels.jpg";
  ...
  "menus.clock.weather.location" = "Santo Domingo";
  ...
  "menus.transitionTime" = 250;
  "theme.bar.buttons.workspaces.smartHighlight" = true;
  "bar.workspaces.reverse_scroll" = false;
  "bar.windowtitle.truncation_size" = 400;
  ...
  "menus.dashboard.powermenu.avatar.image" = "/home/mitra/Pictures/profile.jpg";
  "menus.dashboard.shortcuts.left.shortcut2.tooltip" = "Cider";
  "menus.dashboard.shortcuts.left.shortcut2.command" = "appimage-run ~/AppImages/Cider/Cider.AppImage";
  ...
  "menus.dashboard.directories.left.directory2.command" = "bash -c \"xdg-open $HOME/Pictures/\"";
  "menus.dashboard.directories.right.directory1.command" = "bash -c \"xdg-open $HOME/WebstormProjects/\"";
  "menus.dashboard.stats.interval" = 2000;
  "theme.bar.menus.menu.dashboard.profile.size" = "8.5em";
  "theme.font.label" = "Sans";
  "theme.bar.menus.menu.dashboard.scaling" = 95;
